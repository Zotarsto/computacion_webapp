 ...
 public idUser: Number = 0;
  ...
  ngOnInit(): void {
    ...
    if(this.activatedRoute.snapshot.params['id'] != undefined){
      ...
      this.admin = this.administradorService.esquemaAdmin();
  ...
  public registrar(){
    ...
    this.errors = this.administradorService.validarAdmin(this.admin, this.editar)
    ...
    if(this.admin.password == this.admin.confirmar_password){
      ...
      this.administradorService.registrarAdmin(this.admin).subscribe(
        (response)=>{
